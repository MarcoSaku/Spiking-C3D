...
void LRNLayer<Dtype>::SetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  case LRNParameter_NormRegion_ACROSS_CHANNELS:
    ...
    scale_.Reshape(num_, channels_, length_, height_, width_);
    break;
  case LRNParameter_NormRegion_WITHIN_CHANNEL:
    {
      ...
      square_input_.Reshape(num_, channels_, length_, height_, width_);
      ...
      CHECK_EQ(square_output_.length(), length_);
      ...
      CHECK_EQ(pool_output_.length(), length_);
      ...
      CHECK_EQ(power_output_.length(), length_);
