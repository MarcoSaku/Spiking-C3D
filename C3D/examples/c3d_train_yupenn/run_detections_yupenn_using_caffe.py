...
def main():
    ...
    model_file = './snapshots/yupenn_train_poolmean_nobias/yupenn_train_poolmean_nobias_iter_5250'
    #mean_file = 'ucf101_train_mean.npy'
    mean_file = './mean_yupenn_full_26vid.binaryproto'
    ...
    test_video_list = './lst_files/test_yupenn_full_4vid_shuffle.lst'
    import csv
