...
def print_network_weights(prototxt_filename, caffemodel_filename):
    ...
    net = caffe.Net(prototxt_filename,caffemodel_filename)
...
def main():
    ...
    # Set parameters
    solver_prototxt_filename = 'proto_files/conv3d_ucf101_solver_titan.prototxt'
    prototxt_filename = 'proto_files/conv3d_ucf101_train_nobias.prototxt'
    ...
    caffemodel_filename = 'snapshots/conv3d_ucf101_3classes_titan_nobias_iter_630' # generated by train()
...
###    Train network
    ...
    # Print network
    print_network(prototxt_filename, caffemodel_filename)
    print_network_weights(prototxt_filename, caffemodel_filename)
