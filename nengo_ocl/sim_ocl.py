...
from nengo_ocl.clra_nonlinearities import (
    plan_timeupdate, plan_reset, plan_copy, plan_slicedcopy, plan_probes,
    plan_lif, plan_lif_rate, plan_direct, plan_linear_synapse,
    plan_elementwise_inc,
    init_rng, get_dist_enums_params, plan_whitenoise, plan_presentinput, plan_presentinput_3D,
    plan_conv2,plan_conv3, plan_pool2, plan_pool3)
